...
6. **Beat/miss vs consensus**, not vs prior. Cooler-than-expected CPI/PPI is a **miss**. For inverted series (jobless claims, unemployment), below-consensus is **not** a “beat” — say below/above consensus; do not swap market tone for the print label.
