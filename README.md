...
See **[docs/PUBLIC_SITE.md](./docs/PUBLIC_SITE.md)** for GitHub Pages and the weekday 08:00 China-time Cursor Automation.

- Permanent URL: https://linshanova-ops.github.io/daily-financial-insights/
- Auto-deploy: push to `main`
- Updates: Cursor Automation weekdays 08:00 China time (fail-closed PR + accuracy CI)
