...
No IMAP in this VM; do not `gh workflow run` (403). One pass: 今日图表 (open the PNG), 市场一览, 国际要闻, 大中华, 日程 → calendar (FOMC 2pm ET = 02:00 Beijing next day; window is briefing day through next Friday). Then rewrite Themes to the skill Theme card block — do not restate that contract here. Closes live in marketDashboard only: do not repeat close prints in Global or China. Extra FACT prints follow mail bullets. After live $TODAY, stop/archive so tomorrow's 09:00 can fire.
