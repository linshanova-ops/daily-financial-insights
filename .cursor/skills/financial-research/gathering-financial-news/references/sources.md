...
- **BlockBeats / 律动 (theblockbeats.info)** — required China-facing crypto–macro desk. Use the **解读 / news** that moves a book (TGA size, QE-or-not, placing demand), labeled CLAIM. A flash that only restates a CoinDesk BTC print is not enough. Verify hard macro **and crypto price** prints against tier 1–2. Never publish a BlockBeats BTC/ETH level without confirming the flash's calendar year and an independent dated quote in the coverage window (stale "7月15日 / $116k" flashes have already polluted a 2026 briefing). Skip meme/PnL/KOL price targets.
